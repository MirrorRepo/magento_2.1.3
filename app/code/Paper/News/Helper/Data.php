...
{
	const XML_PATH_PAPER_NEWS = 'Paper_News/';
	...
	{
		return $this->getConfigValue(self::XML_PATH_PAPER_NEWS.'general/'.$fieldid, $storeCode);
	}

	public function getStorefrontConfig($fieldid, $storeCode = null)
	{
		return $this->getConfigValue(self::XML_PATH_PAPER_NEWS.'storefront/'.$fieldid, $storeCode);
	}
}
?>
