...
class Massimport extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (!empty($coll_data)) {
            ...
            $productids = array_chunk($coll_data, $this->bulk_upload_batch);
            //$ids = array_slice($productids, 7, 16);
            //echo "<pre>";print_r($ids);print_r($productids);die;
            ...
            $resultPage->getConfig()->getTitle()->prepend(__('Upload Products On Jet'));
            return $resultPage;
        } else {
