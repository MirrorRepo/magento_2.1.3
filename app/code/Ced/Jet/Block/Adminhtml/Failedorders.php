...
class Failedorders extends \Magento\Backend\Block\Widget\Container
{
	/**
	 * @var string
	 */
	public $_template = 'failed/order/view.phtml';
	...
	{	
		$this->setChild(
				'grid',
				$this->getLayout()->createBlock('Ced\Jet\Block\Adminhtml\Failedorders\Grid', 'grid.view.grid')
		);
