...
class Attribute extends \Magento\Backend\Block\Widget\Container
{
	 ...
	 * @var string
	 */
	public $_template = 'attribute/view.phtml';
	...
	{	
		$this->setChild(
				'grid',
				$this->getLayout()->createBlock('Ced\Jet\Block\Adminhtml\Attribute\Grid', 'grid.view.grid')
		);
	...
	public function _getAddButtonOptions()
	{
		...
		$this->buttonList->add('upload', $splitButtonOptions);
