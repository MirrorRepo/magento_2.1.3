...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
    	...
    	if($profileCode)
    	{
    	$profile = $this->_objectManager->create('Ced\Ebay\Model\Profile')->getCollection()->addFieldToFilter('profile_code',$profileCode)->getFirstItem();
    	...
    	else
    	{
            ...
            $profile = $this->_objectManager->create('Ced\Ebay\Model\Profile');
            $this->_coreRegistry->register('current_profile', $profile);
