...
class Profileproducts extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Ced\Ebay\Model\ResourceModel\Profileproducts');
    }
    ...
    {
        return $this->getResource('Ced\Ebay\Model\ResourceModel\Profileproducts\Collection');
    }
