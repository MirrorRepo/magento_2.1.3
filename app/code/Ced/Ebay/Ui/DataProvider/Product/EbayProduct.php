...
namespace Ced\Ebay\Ui\DataProvider\Product;
 ...
 * Class JetProduct
 */
class EbayProduct extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
     * Product collection
     *
    ...
    public function __construct(
        ...
        $ids = [];
        $result = $this->objectManager->create('Ced\Ebay\Model\Profileproducts')->getCollection()->getData();
